...
{{--                            </svg>--}}
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                        <div class="flex items-center">
                            <input id="remember_me" name="remember" type="checkbox" class="h-4 w-4 shrink-0 text-blue-600 border-gray-300 rounded" />
...
{{--                        </button>--}}
            ...
            <div class="hidden md:flex w-full h-full items-center bg-primary-verylight rounded-xl p-8">
