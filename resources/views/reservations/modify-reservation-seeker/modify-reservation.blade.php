...
@section('content')
    <div class="max-w-4xl mx-auto p-4 md:p-6">
        <!-- Back button -->
        <a href="{{ route('reservations.seeker') }}" class="inline-flex items-center text-primary hover:underline mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-xl font-bold text-white overflow-hidden mr-4">
                            @if($reservation->provider->image)
                                <img src="{{ asset('storage/' . $reservation->provider->image) }}" alt="{{ ucfirst($reservation->provider->name . ' ' . ucfirst($reservation->provider->lastname)) }}" class="w-full h-full object-cover">
                            @else
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800">{{  'ŠITA REIK PADARYT NAUJA FEATURE' }}</p>
                        </div>
                        @endif
                    </div>
                </div>
