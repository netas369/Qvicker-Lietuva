...
@section('content')
    ...
    <div id="seekerProfileModal" class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 hidden backdrop-blur-sm">
        <div class="relative top-10 mx-auto p-0 border-0 w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 shadow-2xl rounded-2xl bg-white mb-10">
            ...
            <div class="bg-gradient-to-r from-primary-light to-primary-dark text-white px-6 py-5 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-xl font-bold">Kliento Profilis</h3>
                    </div>
                    <button onclick="closeSeekerProfileModal()" class="text-white hover:bg-white/20 rounded-lg p-2 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                ...
                <div class="flex flex-col items-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">{{ ucfirst($reservation->seeker->name) }} {{ ucfirst($reservation->seeker->lastname) }}</h2>
                    <p class="text-gray-500 mt-1">Klientas</p>
                </div>
                ...
                @if($reservation->seeker->aboutme)
                    <div class="mb-6">
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200">
                            <p class="text-gray-700 leading-relaxed">{{ $reservation->seeker->aboutme }}</p>
                        </div>
                    </div>
                @endif

                <!-- Member Since (optional extra info) -->
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-900">
                                    {{ \Carbon\Carbon::parse($reservation->seeker->created_at)->format('Y-m-d') }}                                </p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function scrollToChat() {
            ...
            const chatBox = document.querySelector('[wire\\:id]'); // Adjust selector based on your chat component
            if (chatBox) {
