...
@section('content')
        ...
        <div class="container relative mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 2xl:px-60">
            <div class="text-center space-y-8">
                ...
                <p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
                    Turite klausimų ar reikia pagalbos? Mūsų komanda pasiruošusi jums padėti spręsti bet kokius iššūkius ir atsakyti į visus klausimus.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="container relative mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 2xl:px-60">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                    <form action="{{ route('provider.support.send') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <select id="subject" name="subject" required
                                    ...
                                    <option value="Klientų aptarnavimas" {{ old('subject') == 'Klientų aptarnavimas' ? 'selected' : '' }}>Klientų aptarnavimas</option>
                                    <option value="Užsakymų klausimai" {{ old('subject') == 'Užsakymų klausimai' ? 'selected' : '' }}>Užsakymų klausimai</option>
                                    <option value="Profilio valdymas" {{ old('subject') == 'Profilio valdymas' ? 'selected' : '' }}>Profilio valdymas</option>
    ...
    <div class="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div class="container mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 2xl:px-60">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-primary-light mb-4">Dažni partnerių klausimai</h2>
            ...
            <div class="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Kaip pakeisti profilio informaciją?</h3>
                            <p class="text-gray-600 text-sm">Eikite į "Profilis" skyrių valdymo skydelyje ir redaguokite reikalingą informaciją.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Kada gausiu apmokėjimą?</h3>
                            <p class="text-gray-600 text-sm">Apmokėjimą gausite tiesiogiai iš kliento po darbo atlikimo pagal jūsų susitarimą.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Kaip peržiūrėti užsakymų istoriją?</h3>
                            <p class="text-gray-600 text-sm">Užsakymų istoriją rasite skyriuje "Užsakymai" jūsų partnerio valdymo skydelyje.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 mb-2">Kaip pridėti naują paslaugą?</h3>
                            <p class="text-gray-600 text-sm">Eikite į "Mano paslaugos" skyrių ir spauskite "Pridėti naują paslaugą" mygtuką.</p>
                        </div>
                    </div>
                </div>
            </div>
