...
<head>
    <title>Gavote atsiliepimą - Qvicker</title>
    <!--[if !mso]><!-- -->
...
<div style="display:none;font-size:1px;color:#f8fafc;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
    Gavote atsiliepimą nuo  - {{ $seeker->name }} - Qvicker
</div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:32px;font-weight:bold;line-height:1;text-align:center;color:#266867;">
                                        Q<span style="color: #1A4645;">vicker</span><span style="color: #6b7280; font-size: 12px; margin-left: 4px;">LT</span>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                                ...
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:24px;font-weight:600;line-height:30px;text-align:center;color:#1A4645;">
                                        <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: 600;">
                                            Gavote atsiliepimą, {{ ucfirst($provider_name->name) }}!
                                        </h1>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:center;color:#6b7280;">
                                        <p style="margin: 0;">Puikios naujienos! Paslaugos tiekėjas <strong style="color: #266867;"></strong> Gavote atsiliepimą nuo {{$seeker->name}}. Peržiūrėkite dabar !</p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            @if($reservation->subcategory)
                                <tr>
                                    <td align="left" style="font-size:0px;padding:5px 25px;word-break:break-word;">
                                        <div style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#374151;">
                                            <p style="margin: 0;"><strong style="font-size: 14px; color: #6b7280; line-height: 18px">Kategorija:</strong><br />{{ $reservation->subcategory }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endif
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:5px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#374151;">
                                        <p style="margin: 0;"><strong style="font-size: 14px; color: #6b7280; line-height: 18px">Vardas:</strong><br />{{ $seeker->name }}</p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:5px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#6b7280;">
                                        Jei turite klausimų, susisiekite su Qvicker klientų aptarnavimu.
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#6b7280;background-color:#f8fafc;padding:16px;border-radius:4px;">
                                        ...
                                        <span style="color: #266867; word-break: break-all;">{{ url('/reservation/' . $reservation->id) . '/modify' }}</span>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:center;color:#6b7280;">
                                        Turite klausimų? Susisiekite su mumis: <a href="mailto:info@qvicker.lt" style="color: #266867; text-decoration: none;">info@qvicker.lt</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
