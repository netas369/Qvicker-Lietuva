...
<head>
    ...
    <title>Partnerio pagalbos užklausa</title>
</head>
...
<div style="max-width: 600px; margin: 0 auto; background-color: white;">
    ...
    <div style="padding: 2rem;">
        ...
        <p style="margin-bottom: 2rem; text-align: center; color: #6b7280; font-size: 1.125rem;">
            Gauta nauja pagalbos užklausa nuo partnerio <strong style="color: #266867;">{{ $name }}</strong>
        </p>
    ...
    <div style="background-color: #f8fafc; padding: 2rem; text-align: center; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 0.875rem;">
        <p style="margin: 0 0 0.5rem 0;"><strong>Qvicker</strong> - Partnerių palaikymo sistema</p>
        <p style="margin: 0 0 0.5rem 0;">© {{ date('Y') }} Qvicker. Visos teisės saugomos.</p>
        <p style="margin: 0;">
            Šis laiškas buvo automatiškai sugeneruotas iš partnerių palaikymo formos.
        </p>
    </div>
