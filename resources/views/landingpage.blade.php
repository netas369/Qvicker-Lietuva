                        ...
                        <div class="w-full justify-between items-center gap-4 flex md:flex-row flex-col">
                            ...
                            <div class="hidden md:flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="#266867" stroke-width="1.6" stroke-linecap="round"
                            ...
                            <div class="md:w-1/3 p-6 flex-col justify-start items-center gap-4 inline-flex">
                                ...
                                <h4 class="text-center text-primary text-xl font-semibold">Susisiekite ir
                                    užsakykite</h4>
                                <p class="text-center text-gray-500">Tiesiogiai susisiekite, aptarkite detales ir po
                                    paslaugos
                                    suteikimo palikite atsiliepimą.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        <div class="w-full lg:w-2/5">
                            ...
                            <h2 class="text-4xl font-bold text-gray-900 leading-[3.25rem] mb-8">Jau daugiau nei 100+
                                klientų
                                paliko <span
                            ...
                            <div class="flex items-center justify-center lg:justify-start gap-10">
                                <button id="slider-button-left"
                                        ...
                                        data-carousel-prev>
                                    <svg class="h-6 w-6 text-primary-light group-hover:text-white" viewBox="0 0 24 24"
                                         fill="none"
                        ...
                        <div class="w-full lg:w-3/5">
                            ...
                            <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div
                                        class="swiper-slide group bg-white border border-solid border-gray-300 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-primary">
                                        ...
                                        <p
                                            ...
                                            Reikėjo greitos fotografės paslaugos, dėka myapp Lietuva, turėjau galimybė
                                            greitai
                                            rasti profesionalią fotografę.
                                        </p>
                                    ...
                                    <div
                                        ...
                                        <p
                                            class="text-sm text-gray-500 leading-6 transition-all duration-500 min-h-24 group-hover:text-gray-800">
                                            Reikėjo pagalbos kraustantis į kitą butą, my app lietuva leido man greitai
                                            surasti
                                            puikią pagalbą, vienas nebūčiau susitvarkes.
                                        </p>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-5 mb-5 sm:mb-9">
                                            <img class="rounded-full object-cover"
                                                 src="https://pagedone.io/asset/uploads/1696229969.png" alt="avatar">
                                            <div class="grid gap-1">
                                                <h5 class="text-gray-900 font-medium transition-all duration-500  ">Urte
                                                    N.</h5>
                                        ...
                                        <p
                                            class="text-sm text-gray-500 leading-6 transition-all duration-500 min-h-24 group-hover:text-gray-800">
                                            Reikejo papildomu ranku organizuojant rengini, myapp leido greitai surasti
                                            talentinga mergina pagalbai.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
                            ...
                            <div class="w-full flex-col justify-center items-start gap-8 flex">
                                <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                    ...
                                    <p class="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                                        ...
                                        specialistais jų
                                        mieste. Mūsų platforma
                                        pagrįsta pasitikėjimu ir bendradarbiavimu - nuo kasdienių darbų iki
                                        profesionalių
                                        paslaugų, padedame
                                ...
                                <div
                                    ...
                                    <div class="flex-col justify-start items-start inline-flex">
                                        <h3 class="text-primary-light text-4xl font-bold font-manrope leading-normal">
                                            50+</h3>
                                        <h6 class="text-gray-500 text-base font-normal leading-relaxed">Paslaugų
                                            Rūšių</h6>
                                    </div>
                                    <div class="flex-col justify-start items-start inline-flex">
                                        <h4 class="text-primary-light text-4xl font-bold font-manrope leading-normal">
                                            5000+</h4>
                                        <h6 class="text-gray-500 text-base font-normal leading-relaxed">Atliktų
                                            Užsakymų</h6>
                                    </div>
                                    <div class="flex-col justify-start items-start inline-flex">
                                        <h4 class="text-primary-light text-4xl font-bold font-manrope leading-normal">
                                            500+</h4>
                                        <h6 class="text-gray-500 text-base font-normal leading-relaxed">Įvairių Sričių
                                            Partnerių</h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <img class="sm:ml-0 ml-auto rounded-xl object-cover"
                                 src="{{ asset('images/wedding-planner1.jpg') }}"
                                 alt="about Us image"/>
                        </div>
                    </div>
                </div>
