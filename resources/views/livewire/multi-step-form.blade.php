<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <form wire:submit.prevent="register">
        ...
        @if($currentStep === 2)
            <div class="space-y-8" x-data="{ activeTab: 0 }">
