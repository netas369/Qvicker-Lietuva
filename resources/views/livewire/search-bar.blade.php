<div class="relative">
    ...
    <form class="flex items-center max-w-lg mx-auto mt-10">
        ...
        <div class="relative w-full">
            ...
            <input wire:model.live="search" type="text" id="searchbar" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-verylight focus:border-primary-light block w-full ps-10 p-2.5  ml-2" placeholder="Ieškoti paslaugos..." required />
