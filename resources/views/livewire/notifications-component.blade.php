            ...
            <div class="border-b border-gray-100 pb-4
                ...
                <div class="flex items-start">
                    <div class="flex-shrink-0 mr-3">
                        ...
                        @elseif($notification['type'] === 'App\\Notifications\\NewBookingNotification' || $notification['type'] === 'reservation_requested')
                        ...
                        @elseif($notification['type'] === 'reservation_accepted' || $notification['type'] === 'reservation_completed' || $notification['type'] === 'reservation_automatically_completed')
                            <span class="text-green-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                    ...
                    <div class="flex-1">
                        @if($notification['type'] !== 'reservation_cancelled_by_system')
