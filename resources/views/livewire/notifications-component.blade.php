...
<div class="flex justify-between items-center mb-4">
        <div class="flex items-center">
            <h3 class="text-lg font-semibold text-gray-800">Pranešimai</h3>
            @if($unreadCount > 0)
            ...
            <div class="border-b border-gray-100 pb-4
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        @elseif($notification['type'] === 'new_reservation')
                            <a href="{{ route('reservation.modify', ['id' => $notification['data']['reservation_id']]) }}" class="block hover:bg-gray-50"
                               wire:click.stop="markAsRead('{{ $notification['id'] }}')"
                               wire:navigate>
                                <p class="text-gray-800">
                                    {{ $notification['data']['seeker_name'] }} atsiuntė naują užklausą darbui mieste {{ $notification['data']['city'] }}
                                </p>
                            </a>
