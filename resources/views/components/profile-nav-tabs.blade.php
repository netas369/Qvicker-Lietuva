<div>
    ...
    <div class="bg-gray-50 border-b shadow-sm">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="hidden sm:flex flex-wrap -mb-px justify-center">
                <a href="{{ route('myprofile') }}"
                   class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-base md:text-lg transition duration-150 ease-in-out
